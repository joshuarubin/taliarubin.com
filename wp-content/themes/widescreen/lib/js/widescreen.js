...
jQuery(document).ready(function(){
	...
	jQuery(function(){
		...
		jQuery(".fader").hover(function(){
			jQuery(this).find("img").stop().fadeTo("slow", .4);
			jQuery(this).find("span.title,span.category").stop().fadeTo("slow", 1);
			jQuery(this).find("span.title,span.category").css("color","#fff");
	
		}, function(){
			jQuery(this).find("img").stop().fadeTo("slow", 1);
			jQuery(this).find("span.title,span.category").stop().fadeTo("slow", 0);
